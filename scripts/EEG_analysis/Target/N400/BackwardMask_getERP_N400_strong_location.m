...
% Range from 280ms-500ms post target onset --> 0,25*ms=datapoints. 
% short primer presentation (unconscious trials); onset target 283.4ms after beginning of epoch, 83.4ms after onset primer 
range_min = 141;                                                            % 200ms Baseline+16,7ms Primer+66,7ms Mask(target onset)+280ms = 563,4ms (140,85 datapoints) post beginning of epoch 
range_max = 196;                                                            % 200ms Baseline+16,7ms Primer+66,7ms Mask(target onset)+500ms = 783,4ms (195,85 datapoints) nach post beginning of epoch 
