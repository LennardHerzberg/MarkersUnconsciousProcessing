...
% Range within ERP...
% Range von 200ms-400ms nach Target für vMMN sind --> 0,25*ms=datapoints. 
range_min = 121;                                                            % 200ms Baseline+16,7ms Primer+66,7ms Mask(hier Zeitpunkt Target)+200ms = 483,4ms (120,85 datapoints) nach Epochenbeginn
range_max = 171;                                                            % 200ms Baseline+16,7ms Primer+66,7ms Mask(hier Zeitpunkt Target)+400ms = 683,4ms (170,85 datapoints) nach Epochenbeginn 
...
writecell(dataframe,'/bif/storage/storage1/projects/emocon/Lennard/Target_strong_left_final.xlsx');
