...
%     erp_P100_strong(i,:) = Erp.strong; 
%     erp_P100_weak(i,:) = Erp.weak; 
...
% add header
header = {'subName','mask','emotion','P100_left','condition'};

dataframe = [header; dataframe]; 

% save table in excel 
% writecell(dataframe,'/bif/storage/storage1/projects/emocon/Lennard/Primer_P100_left_final.xlsx');
