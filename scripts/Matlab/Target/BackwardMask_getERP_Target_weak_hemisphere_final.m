function Erp_weak = BackwardMask_getERP_Target_weak_hemisphere_final(EEG,channel1,channel2,range_min,range_max)
...
h_h_weak_vMMNRange = mean_h_h_weak(1,(range_min:range_max)); 
h_n_weak_vMMNRange = mean_h_n_weak(1,(range_min:range_max)); 
h_s_weak_vMMNRange = mean_h_s_weak(1,(range_min:range_max)); 

s_h_weak_vMMNRange = mean_s_h_weak(1,(range_min:range_max)); 
s_n_weak_vMMNRange = mean_s_n_weak(1,(range_min:range_max)); 
s_s_weak_vMMNRange = mean_s_s_weak(1,(range_min:range_max)); 

n_h_weak_vMMNRange = mean_n_h_weak(1,(range_min:range_max)); 
n_n_weak_vMMNRange = mean_n_n_weak(1,(range_min:range_max)); 
n_s_weak_vMMNRange = mean_n_s_weak(1,(range_min:range_max)); 



%% Save vMMN

Erp_weak.h_h_weak_vMMN = min(h_h_weak_vMMNRange);
Erp_weak.h_n_weak_vMMN = min(h_n_weak_vMMNRange);
Erp_weak.h_s_weak_vMMN = min(h_s_weak_vMMNRange);

Erp_weak.s_h_weak_vMMN = min(s_h_weak_vMMNRange);
Erp_weak.s_n_weak_vMMN = min(s_n_weak_vMMNRange);
Erp_weak.s_s_weak_vMMN = min(s_s_weak_vMMNRange);

Erp_weak.n_h_weak_vMMN = min(n_h_weak_vMMNRange);
Erp_weak.n_n_weak_vMMN = min(n_n_weak_vMMNRange);
Erp_weak.n_s_weak_vMMN = min(n_s_weak_vMMNRange);
...
mean_h_weak_congruent   = mean(erp_epoch_h_weak_congruent([channel1,channel2],:),1);
mean_h_weak_incongruent = mean(erp_epoch_h_weak_incongruent([channel1,channel2],:),1);
mean_s_weak_congruent   = mean(erp_epoch_s_weak_congruent([channel1,channel2],:),1);
mean_s_weak_incongruent = mean(erp_epoch_s_weak_incongruent([channel1,channel2],:),1);
mean_n_weak_congruent   = mean(erp_epoch_n_weak_congruent([channel1,channel2],:),1);
mean_n_weak_incongruent = mean(erp_epoch_n_weak_incongruent([channel1,channel2],:),1);

mean_weak = mean(erp_epoch_weak([channel1,channel2],:),1);
...
% Get range of vMMN
h_weak_vMMNRange = mean_h_weak(1,(range_min:range_max));
n_weak_vMMNRange = mean_n_weak(1,(range_min:range_max)); 
s_weak_vMMNRange = mean_s_weak(1,(range_min:range_max)); 

h_weak_congruent_vMMNRange   = mean_h_weak_congruent(1,(range_min:range_max));
h_weak_incongruent_vMMNRange = mean_h_weak_incongruent(1,(range_min:range_max));
s_weak_congruent_vMMNRange   = mean_s_weak_congruent(1,(range_min:range_max));
s_weak_incongruent_vMMNRange = mean_s_weak_incongruent(1,(range_min:range_max));
n_weak_congruent_vMMNRange   = mean_n_weak_congruent(1,(range_min:range_max));
n_weak_incongruent_vMMNRange = mean_n_weak_incongruent(1,(range_min:range_max));


weak_vMMNRange = mean_weak(1,(range_min:range_max)); 


% Save vMMN
Erp_weak.h_weak_vMMN = min(h_weak_vMMNRange);
Erp_weak.n_weak_vMMN = min(n_weak_vMMNRange);
Erp_weak.s_weak_vMMN = min(s_weak_vMMNRange);


Erp_weak.h_weak_congruent_vMMN   = min(h_weak_congruent_vMMNRange);
Erp_weak.h_weak_incongruent_vMMN = min(h_weak_incongruent_vMMNRange);
Erp_weak.s_weak_congruent_vMMN   = min(s_weak_congruent_vMMNRange);
Erp_weak.s_weak_incongruent_vMMN = min(s_weak_incongruent_vMMNRange);
Erp_weak.n_weak_congruent_vMMN   = min(n_weak_congruent_vMMNRange);
Erp_weak.n_weak_incongruent_vMMN = min(n_weak_incongruent_vMMNRange);


Erp_weak.weak_vMMN = min(weak_vMMNRange);
